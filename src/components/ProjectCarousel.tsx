      ...
      >
        <CarouselContent className="-ml-1 sm:-ml-2 md:-ml-4">
          {projectImages.map((project) => (
            ...
            >
              <div className="w-full h-64 sm:h-72 md:h-80 lg:h-96 flex items-center justify-center bg-muted rounded-lg sm:rounded-xl shadow-md sm:shadow-lg transition-all duration-300 hover:shadow-xl overflow-hidden">
                <OptimizedImage
                  src={project.src}
                  alt={project.alt}
